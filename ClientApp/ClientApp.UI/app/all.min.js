...
!function(){"use strict";var t=angular.module("app",["ngAnimate","ngRoute","ngSanitize","angular.filter","treeControl","textAngular","angularUtils.directives.dirPagination","common","common.bootstrap","ui.bootstrap"]);t.run(["$route",function(t){}])}();
...
!function(){"use strict";function t(t,e){e.forEach(function(e){t.when(e.url,e.config)}),t.otherwise({redirectTo:"/"})}function e(t){return[{url:"/",config:{templateUrl:t+"/app/dashboard/dashboard.html",title:"dashboard",settings:{nav:1,content:'<i class="fa fa-dashboard"></i> Dashboard'}}},{url:"/admin",config:{title:"admin",templateUrl:t+"/app/admin/admin.html",settings:{nav:2,content:'<i class="fa fa-lock"></i> Admin'}}},{url:"/test",config:{title:"test",templateUrl:t+"/app/test/test.html",settings:{nav:3,content:'<i class="fa fa-lock"></i> Test'}}},{url:"/tree",config:{title:"Standards People",templateUrl:t+"/app/tree/tree.html",settings:{nav:4,content:'<i class="fa fa-user"></i> Standards People'}}}]}var a=angular.module("app"),n="/Tree";a.constant("routes",e(n)),a.constant("url_prefix",n),a.config(["$routeProvider","routes",t])}();
...
!function(){"use strict";function t(t,e){function o(){var e=[r(),a()];t.activateController(e,n).then(function(){i("")})}function r(){return e.getMessageCount().then(function(t){return c.messageCount=t})}function a(){return e.getPeople().then(function(t){return c.people=t})}var u=t.logger.getLogFn,i=u(n),c=this;c.news={title:"ABB Group Standards",description:""},c.messageCount=0,c.people=[],c.title="Dashboard",o()}var n="dashboard";angular.module("app").controller(n,["common","datacontext",t])}();
!function(){"use strict";function n(n,e,t,r){function s(){l("App!",null,!0),e.activateController([],o)}function i(n){c.isBusy=n}var c=this,l=e.logger.getLogFn(o,"success"),u=t.events;c.url_prefix=r,c.busyMessage="Please wait ...",c.isBusy=!0,c.spinnerOptions={radius:40,lines:7,length:0,width:30,speed:1.7,corners:1,trail:100,color:"#F58A00"},s(),n.$on("$routeChangeStart",function(n,o,e){i(!0)}),n.$on(u.controllerActivateSuccess,function(n){i(!1)}),n.$on(u.spinnerToggle,function(n){i(n.show)})}var o="shell";angular.module("app").controller(o,["$rootScope","common","config","url_prefix",n])}();
!function(){"use strict";function t(t,n,r,i){function e(){u()}function u(){c.navRoutes=r.filter(function(t){return t.config.settings&&t.config.settings.nav}).sort(function(t,n){return t.config.settings.nav-n.config.settings.nav})}function o(n){if(!n.config.title||!t.current||!t.current.title)return"";var r=n.config.title;return t.current.title.substr(0,r.length)===r?"current":""}var c=this;c.isCurrent=o,c.url_prefix=i,e()}var n="sidebar";angular.module("app").controller(n,["$route","config","routes","url_prefix",t])}();
...
!function(){"use strict";var e=angular.module("app");e.directive("ccImgPerson",["config",function(e){function n(e,n,r){r.$observe("ccImgPerson",function(e){e=i+(e||t),r.$set("src",e)})}var i=e.imageSettings.imageBasePath,t=e.imageSettings.unknownPersonImageSource,r={link:n,restrict:"A"};return r}]),e.directive("ccSidebar",function(){function e(e,n,i){function t(e){function n(){r.slideUp(350),$(".sidebar-dropdown a").removeClass(i)}var i="dropy";e.preventDefault(),a.hasClass(i)?a.hasClass(i)&&(a.removeClass(i),r.slideUp(350)):(n(),r.slideDown(350),a.addClass(i))}var r=n.find(".sidebar-inner"),a=n.find(".sidebar-dropdown a");n.addClass("sidebar"),a.click(t)}var n={link:e,restrict:"A"};return n}),e.directive("ccWidgetClose",function(){function e(e,n,i){function t(e){e.preventDefault(),n.parent().parent().parent().hide(100)}i.$set("href","#"),i.$set("wclose"),n.click(t)}var n={link:e,template:'<i class="fa fa-remove"></i>',restrict:"A"};return n}),e.directive("ccWidgetMinimize",function(){function e(e,n,i){function t(e){e.preventDefault();var i=n.parent().parent().next(".widget-content"),t=n.children("i");i.is(":visible")?(t.removeClass("fa fa-chevron-up"),t.addClass("fa fa-chevron-down")):(t.removeClass("fa fa-chevron-down"),t.addClass("fa fa-chevron-up")),i.toggle(500)}i.$set("href","#"),i.$set("wminimize"),n.click(t)}var n={link:e,template:'<i class="fa fa-chevron-up"></i>',restrict:"A"};return n}),e.directive("ccScrollToTop",["$window",function(e){function n(n,i,t){function r(){a.scrollTop()>300?i.slideDown():i.slideUp()}var a=$(e);i.addClass("totop"),a.scroll(r),i.find("a").click(function(e){e.preventDefault(),$("body").animate({scrollTop:0},500)})}var i={link:n,template:'<a href="#"><i class="fa fa-chevron-up"></i></a>',restrict:"A"};return i}]),e.directive("ccSpinner",["$window",function(e){function n(n,i,t){n.spinner=null,n.$watch(t.ccSpinner,function(t){n.spinner&&n.spinner.stop(),n.spinner=new e.Spinner(t),n.spinner.spin(i[0])},!0)}var i={link:n,restrict:"A"};return i}]),e.directive("ccWidgetHeader",["url_prefix",function(e){function n(e,n,i){i.$set("class","widget-head")}var i={link:n,scope:{title:"@",subtitle:"@",rightText:"@",allowCollapse:"@"},templateUrl:e+"/app/layout/widgetheader.html",restrict:"A"};return i}])}();
!function(){"use strict";function t(t){function n(){t.activateController([],e).then(function(){i("Activated Test View")})}var o=t.logger.getLogFn,i=o(e),c=this;c.title="Test",n()}var e="test";angular.module("app").controller(e,["common",t])}();
!function(){"use strict";angular.module("app").config(function(e,t){e.setPath(t+"/bower_components/angular-dir-pagination/dirPagination.tpl.html")}).controller("TreeController",["$scope","$http","url_prefix","common","filterFilter",function(e,t,o,n,i){e.treeOptions={nodeChildren:"a3",dirSelectable:!0},e.memberPagination={current:1},e.userPagination={current:1},e.getpath=function(){return"abc"},e.filteredMembers=[],e.filteredUsers=[],e.originalmembers=[],e.originalUsers=[],e.members=[],e.originaluser=[],e.users=[],e.totalUsers=0,e.totalMembers=0,e.modalWindow=null,e.listOfMembers=[],e.committeesOfMember=[],e.deleteMember=[],e.editedCommittee=[],e.currentCommitteeId=-1,e.indexOfDeleteUser=-1,e.indexOfDeleteUserCommittee=-1,e.selectedUser=[],e.committeesByParentId=[],e.currentOrganizationId=-1,e.deletedCommittee=[],e.notes=[],e.errorTextMessageNoChildren="",e.errorTextMessageNoMembers="",e.errorTextMessageNoNotes="",e.blockedDeleting=!1,e.fullName="",e.showCircle=!1,e.listOfAttachments=[],e.openCommitteeDetails=function(n){t.get(o+"/api/member/GetCommittee/"+n).then(function(t){e.listOfMembers=t.data,e.ShowCommittee(n),e.currentCommitteeId=n,e.tab=1,e.subtab=2,e.getFullName(),e.getCommitteesByParentId(),e.getNotesByCommitteeId(),e.blockedDeletingOrg=!1}),t.get(o+"/api/GetCommittees/GetCommittee/"+n).then(function(t){e.tab=1,e.subtab=2,e.getFullName(),e.descOfCommittee=t.data[0].a4,e.nameOfCommitteeText=t.data[0].a1,e.descOfCommitteeText=t.data[0].a4,e.currentOrganizationId=t.data[0].a5})},e.openCommitteeDetailsFromModal=function(n){t.get(o+"/api/member/GetCommittee/"+n).then(function(t){e.listOfMembers=t.data,e.ShowCommittee(n),e.currentCommitteeId=n,e.tab=1,e.subtab=1,e.getFullName(),e.getCommitteesByParentId(),e.getNotesByCommitteeId()}),t.get(o+"/api/GetCommittees/GetCommittee/"+n).then(function(t){e.tab=1,e.subtab=1,e.getFullName(),e.descOfCommittee=t.data[0].a4,e.nameOfCommitteeText=t.data[0].a1,e.descOfCommitteeText=t.data[0].a4,e.currentOrganizationId=t.data[0].a5})},e.getCommitteesByOrgId=function(){t.get(o+"/api/committee/GetFullNameOfCommitteesByOrgId/"+e.selectedNode.id).then(function(t){e.committeesByParentId=t.data})},e.getCommitteesByParentId=function(){t.get(o+"/api/getcommittees/GetCommitteesByParentId/"+e.currentCommitteeId).then(function(t){e.committeesByParentId=t.data,e.ShowCommittee(e.currentCommitteeId)})},e.deleteMembers=function(n){n=e.deleteMember;var i=t({method:"post",url:o+"/api/member/deleteuser/"+n.id,data:n,datatype:"application/json"}).success(function(){e.listOfMembers.splice(e.indexOfDeleteUser,1),e.committeesOfMember.splice(e.indexOfDeleteUserCommittee,1)});return i},e.openDeleteQuestionFromModal=function(n,i){t.get(o+"/api/member/GetMemberByMembershipId/"+n).then(function(t){e.deleteMember=t.data[0],e.indexOfDeleteUserCommittee=i})},e.openDeleteQuestion=function(n,i){t.get(o+"/api/member/GetMemberByMembershipId/"+n).then(function(t){e.deleteMember=t.data[0],e.indexOfDeleteUser=i})},e.openUserDetails=function(n){t.get(o+"/api/getmemberbyid/GetMemberByUserId/"+n).then(function(t){e.committeesOfMember=t.data,e.nameOfMember=t.data[0].user.a2+" "+t.data[0].user.a3})},e.memberPageChanged=function(t){e.memberPagination.current=t;var o=20*(e.memberPagination.current-1),n=o+20;e.filteredMembers=e.members.slice(o,n),e.totalMembers=e.members.length},e.$watch("searchMember",function(t){""===t?e.members=e.originalmembers:e.members=e.originalmembers.filter(function(e){var o=-1!==e.user.a1.indexOf(t);return o}),e.memberPageChanged(1)}),e.$watch("searchUser",function(t){""===t?e.users=e.originalUsers:e.users=e.originalUsers.filter(function(e){var o=-1!==e.a1.indexOf(t);return o}),e.userPageChanged(1)}),e.userPageChanged=function(t){e.userPagination.current=t;var o=20*(e.userPagination.current-1),n=o+20;e.filteredUsers=e.users.slice(o,n),e.totalUsers=e.users.length};var a=n.logger.getLogFn("TreeController","success");a("Loading organization structure",null,!0),t.get(o+"/api/committee/get").then(function(n){e.dataForTheTree=n.data.Organizations,a("Organizations are loaded successfully",null,!0),$(document).ready(function(){$("#img1").hide()}),a("Loading members",null,!0),t.get(o+"/api/member/Get").then(function(n){e.members=n.data.Memberships,e.originalmembers=n.data.Memberships,e.totalMembers=e.members.length,a("Members are loaded successfully",null,!0),$(document).ready(function(){$("#img2").hide()}),t.get(o+"/api/getcommittees/Get").then(function(n){e.committees=n.data.Committees,e.memberPageChanged(1),a("Loading users",null,!0),t.get(o+"/api/getusers/Get").then(function(t){a("Users are loaded successfully",null,!0),$(document).ready(function(){$("#img3").hide()}),e.users=t.data.Users,e.originalUsers=t.data.Users,e.totalUsers=e.users.length,e.userPageChanged(1)})})})}),e.getFullName=function(){t.get(o+"/api/getcommittees/GetFullNameOfCommittee/"+e.currentCommitteeId).then(function(t){var o=t.data,n=o.substr(1);o=n.substr(0,n.length-1),e.nameOfCommittee=o})},e.tab=3,e.showSelected=function(n){e.selectedNode=n,e.selectedNodeId=n.id,e.currentCommitteeId=n.id,e.currentOrganizationId=n.a5,t.get(o+"/api/member/GetCommittee/"+e.selectedNodeId).then(function(t){return e.tab=1,e.subtab=1,0===t.data.length?void(e.listOfMembers=[]):void(e.listOfMembers=t.data)}),angular.isUndefined(e.selectedNode.a4)?(e.showCircle=!0,e.blockedDeletingOrg=!0,t.get(o+"/api/Committee/GetCommByOrgId/"+e.selectedNodeId).then(function(t){e.tab=1,e.subtab=1,e.currentCommitteeId=-1,e.nameOfCommittee=e.selectedNode.a1,e.descOfCommittee="",e.getCommitteesByOrgId(),e.getNotesByCommitteeId(),e.nameOfCommitteeText=e.selectedNode.a1,e.descOfCommitteeText="",e.showCircle=!1})):t.get(o+"/api/GetCommittees/GetCommittee/"+e.selectedNodeId).then(function(t){e.tab=1,e.subtab=1,e.getFullName(),e.descOfCommittee=t.data[0].a4,e.getNotesByCommitteeId(),e.nameOfCommitteeText=t.data[0].a1,e.descOfCommitteeText=t.data[0].a4,e.blockedDeletingOrg=!1}),e.getCommitteesByParentId()},e.filterByCommitteeId=function(t){return e.selectedNode?t.committeeId==e.selectedNode.id:!0},e.expandedNodes=[],e.ShowCommittee=function(t){var o=(e.flattenArray(e.dataForTheTree),e.getAllParents(e.dataForTheTree,parseInt(t)));o.pop(),e.expandedNodes=o;var n=o.pop();e.selectedNode=n},e.filterBySearchText=function(t){if(!t||!e.searchText)return!0;var o=t.user.a2+t.user.a3;return"undefined"===o?!0:-1!=o.toLowerCase().indexOf(e.searchText.toLowerCase())},e.flattenArray=function(t,o){return o=o||[],t.forEach(function(t){o.push(t),t.a3&&0!==t.a3.length&&(t.children=t.children||[],e.flattenArray(t.children,o))}),o},e.getAllParents=function(t,o,n){return n=n||[],t.forEach(function(t){if(n.push(t),o===t.id)return n.push({result:!0}),n;if(t.a3.length>0){n=e.getAllParents(t.a3,o,n);var i=n.pop();if(i.result)return n.push({result:!0}),n;n.push(i)}n.pop()}),n},e.search=function(t){return void 0==e.searchText?!0:-1!=t.name.toLowerCase().indexOf(e.searchText.toLowerCase())},e.a1="",e.a2="",e.a3="",e.AddMem=function(){e.a1=e.selectedUser.a1,e.a2=e.selectedUser.a2,e.a3=e.selectedUser.a3;var n={CommitteeId:e.currentCommitteeId,UserId:e.selectedUser.id};t({method:"post",url:o+"/api/addmember/get",data:n,datatype:"application/json"}).success(function(t){e.NewMember=t,e.listOfMembers.push(e.NewMember)})},e.sendEditedCommitteDetails=function(){e.showCircle=!0;var n={Symbol:e.nameOfCommitteeText,Description:e.descOfCommitteeText,Id:e.currentCommitteeId};t({method:"post",url:o+"/api/getcommittees/EditCommittee",data:n,datatype:"application/json"}).success(function(n){e.editedCommittee=n,e.nameOfCommittee=e.editedCommittee.a1,e.descOfCommittee=e.editedCommittee.a2,t.get(o+"/api/committee/get").then(function(t){e.dataForTheTree=t.data.Organizations}).then(function(t){e.ShowCommittee(e.currentCommitteeId),e.getFullName(),e.showCircle=!1})})},e.addSubcommittee=function(){var n={Symbol:e.newCommitteeNameText,Description:e.newCommitteDescriptionText,ParentId:e.currentCommitteeId,OrganizationID:e.currentOrganizationId};t({method:"post",url:o+"/api/getcommittees/AddSubcommittee",data:n,datatype:"application/json"}).success(function(n){e.newCommittee=n,e.committeesByParentId.push(e.newCommittee),t.get(o+"/api/committee/get").then(function(t){e.dataForTheTree=t.data.Organizations}).then(function(t){e.ShowCommittee(e.currentCommitteeId),e.getFullName(),e.getCommitteesByParentId(),e.newCommitteeNameText="",e.newCommitteDescriptionText=""})})},e.getDesc=function(){t.get(o+"/api/getcommittees/getcommittee/"+e.currentCommitteeId).then(function(t){e.descOfCommittee=t.data[0].a4,e.descOfCommitteeText=t.data[0].a4,e.nameOfCommitteeText=t.data[0].a1})},e.deleteCommittee=function(){e.showCircle=!0,t({method:"post",url:o+"/api/getcommittees/DeleteCommittee/"+e.deletedCommittee,data:e.deletedCommittee,datatype:"application/json"}).success(function(n){t.get(o+"/api/committee/get").then(function(t){e.dataForTheTree=t.data.Organizations}).then(function(t){e.ShowCommittee(e.deletedCommittee.a2),e.currentCommitteeId=e.deletedCommittee.a2,e.getFullName(),e.getDesc(),e.showCircle=!1})})},e.openDeleteCommitteeModal=function(){t.get(o+"/api/getcommittees/getcommittee/"+e.currentCommitteeId).then(function(t){e.deletedCommittee=t.data[0],e.deletedCommittee.a3.length>0?e.errorTextMessageNoChildren="Deleting committe must have no children":e.errorTextMessageNoChildren="",e.listOfMembers.length>0?e.errorTextMessageNoMembers="Deleting committe must have no members":e.errorTextMessageNoMembers="",e.notes.length>0?e.errorTextMessageNoNotes="Deleting committe must have no notes":e.errorTextMessageNoNotes="",e.deletedCommittee.a3.length>0||e.listOfMembers.length>0||e.notes.length>0?e.blockedDeleting=!0:e.blockedDeleting=!1;for(var o=[e.errorTextMessageNoNotes,e.errorTextMessageNoMembers,e.errorTextMessageNoChildren],n=0;n<o.length;n++)o[n].length<2&&o.splice(n,1);e.allErrors=o})},e.getNotesByCommitteeId=function(){t.get(o+"/api/note/GetNotes/"+e.currentCommitteeId).then(function(t){e.notes=t.data;for(var o=0;o<e.notes.length;o++){var n=e.notes[o].a3,i=n.replace("T"," "),a=i.slice(0,16);e.notes[o].a3=a}})},e.addNote=function(){var n={Message:e.newNote,CommitteeId:e.currentCommitteeId,NoteAttachments:e.listOfAttachments};t({method:"post",url:o+"/api/note/AddNote",data:n,datatype:"application/json"}).success(function(t){e.AddedNote=t;var o=e.AddedNote.a3,n=o.replace("T"," "),i=n.slice(0,16);e.AddedNote.a3=i,e.notes.push(e.AddedNote),e.getNotesByCommitteeId(),e.newNote=""})},e.deleteNotes=function(n){n=e.deleteNote;var i=t({method:"post",url:o+"/api/note/DeleteNote/"+n.id,data:n,datatype:"application/json"}).success(function(){e.notes.splice(e.indexOfDeleteNote,1)});return i},e.openDeleteNoteQuestion=function(n,i){t.get(o+"/api/note/GetNotesByNoteId/"+n).then(function(t){e.deleteNote=t.data,e.indexOfDeleteNote=i})},e.openDeleteSubcommitteeQuestionFromModal=function(n,i){e.deletedSubcommitteeId=n,e.indexOfdeletedSubcommittee=i,t.get(o+"/api/getcommittees/getsubcommittee/"+e.deletedSubcommitteeId).then(function(t){e.deletedSubcommittee=t.data[0],e.deletedSubcommittee.a3.length>0?e.errorTextMessageNoChildren="Deleting committe must have no children":e.errorTextMessageNoChildren="",e.deletedSubcommittee.a4.length>0?e.errorTextMessageNoMembers="Deleting committe must have no members":e.errorTextMessageNoMembers="",e.deletedSubcommittee.a5.length>0?e.errorTextMessageNoNotes="Deleting committe must have no notes":e.errorTextMessageNoNotes="",e.deletedSubcommittee.a3.length>0||e.deletedSubcommittee.a4.length>0||e.deletedSubcommittee.a5.length>0?e.blockedDeleting=!0:e.blockedDeleting=!1;for(var o=[e.errorTextMessageNoNotes,e.errorTextMessageNoMembers,e.errorTextMessageNoChildren],n=0;n<o.length;n++)o[n].length<2&&o.splice(n,1);e.allSubcommitteeErrors=o})},e.deleteSubcommittee=function(){e.showCircle=!0,t({method:"post",url:o+"/api/getcommittees/DeleteCommittee/"+e.deletedSubcommittee,data:e.deletedSubcommittee,datatype:"application/json"}).success(function(t){e.ShowCommittee(e.currentCommitteeId),e.committeesByParentId.splice(e.indexOfdeletedSubcommittee,1),e.showCircle=!1})},e.actualNoteAttachmentId=-1,$(document).ready(function(){Dropzone.autoDiscover=!1,$("#dZUpload").dropzone({url:o+"/api/NoteAttachment/Post",addRemoveLinks:!0,success:function(n,i){var a=i;n.previewElement.classList.add("dz-success"),console.log("Successfully uploaded :"+a),t.get(o+"/api/noteattachment/post").success(function(t){e.actualNoteAttachmentId=i,e.listOfAttachments.push(e.actualNoteAttachmentId)})},error:function(e,t){e.previewElement.classList.add("dz-error")}})}),e.openNoteDetails=function(n,i){t.get(o+"/api/note/GetNotesByNoteId/"+n).then(function(t){e.actualNote=t.data,e.actualAttachment=t.data.a5})},e.getTheFile=function(e){t({method:"GET",cache:!1,url:o+"/api/NoteAttachment/GetLinksToAttachments/"+e,headers:{"Content-Type":"application/json; charset=utf-8"}}).success(function(e,t){console.log(e)}).error(function(e,t){})}}])}();
